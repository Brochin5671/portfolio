...
export const projectData = [
  {
    ...
    imgsrc: `${PATH}statusfer_preview.png`,
  ...
  },
  {
    ...
    imgsrc: `${PATH}science_fetcher_preview.png`,
  ...
  },
  {
    ...
    imgsrc: `${PATH}escape_fractal_viewer_preview.png`,
    srcLink: "https://github.com/Brochin5671/math-beauty",
    link: "https://escape-fractal-viewer.fly.dev/",
  },
  {
    name: "Blobbed",
    desc: "Grade 10 computer science final project using Python2 and Pygame in 2017. Avoid enemies and reach the portals to fight the final boss.",
    imgsrc: `${PATH}blobbed_preview.png`,
    srcLink: "https://github.com/Brochin5671/blobbed-game",
    link: "https://brochin5671.itch.io/blobbed",
  },
  {
